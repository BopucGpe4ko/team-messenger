...
// const EAS_PROJECT_ID = "c242a126-2859-4bf9-b146-0a486f7c85d7"; // EAS Project ID - закоментовано, буде створено новий
const PROJECT_SLUG = "team-messenger"; // Project slug
const OWNER = "absudo"; // Owner

const APP_NAME = "clone-twitter"; // Назва додатку
const BUNDLE_IDENTIFIER = "com.absudos.clonetwitter"; // iOS bundle identifier
const PACKAGE_NAME = "com.absudos.clonetwitter"; // Android package name
const SCHEME = "uamess"; // Custom URL scheme
...
export default ({ config }: ConfigContext): ExpoConfig => {
  ...
  return {
    ...
    extra: {
      eas: {
        projectId: "9fce022f-f612-4509-844e-34a1b1bc207a",
      },
      router: {},
    },
